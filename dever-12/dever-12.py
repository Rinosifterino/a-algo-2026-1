...
class Grafo:
    ...
    def executar_kruskal_maximo(self):
        ...
        # Passo 1: Ordenar todas as arestas do MAIOR para o MENOR peso
        # A alteração fundamental ocorre aqui (reverse=True)
        ...
        while e < self.v - 1:
            ...
            # Se as raízes forem diferentes, não forma ciclo.
            if x != y:
                e = e + 1
...
if __name__ == '__main__':
    ...
    # ==========================================
    # INPUT: Definição das arestas e pesos
    # ==========================================
    ...
    # ==========================================
    # OUTPUT: Visualização do resultado em terminal
    # ==========================================
    print("--- RESULTADO: ÁRVORE GERADORA MÁXIMA ---")
    print("Rotas mais caras escolhidas sem formar ciclos:")
    for u, v, peso in caminho_final:
        print(f"Rota da cidade {u} para a cidade {v} | Custo: {peso}")
    print(f"\nCusto Máximo Total: {custo_final}")
